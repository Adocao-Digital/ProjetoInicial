...
<body>
    ...
    <main>
        ...
        <!-- Blocos com opções -->
        <!-- Blocos com opções (usando cards) -->
<!-- Blocos com opções (apenas cards) -->
<div class="d-flex flex-wrap justify-content-center gap-4 mt-5">
    <div class="card">
        ...
        <div>
            <a href="quero-adotar.php" class="stretched-link">
                <p>Encontre seu melhor amigo</p>
            </a>
        </div>
    </div>
    <div class="card">
        <a href="cadastro-pet.php">
            <img src="img/form.png" alt="Imagem formulário">
        </a>
        <div>
            <a href="cadastro-pet.php" class="stretched-link">
    ...
    <div class="card">
        ...
        <div>
            <a href="cadastro.php" class="stretched-link">
