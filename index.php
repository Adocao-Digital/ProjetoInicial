...
<main>
    <div class="box">
        ...
        <div class="separa">
            <div class="caixa1">
                <a href="quero-adotar.php"><img src="img/pets.png"></a>
                <a href="quero-adotar.php"><p>Encontre seu melhor amigo</p></a>
            </div>  
            <div class="caixa1">   
                <a href="cadastro-pet.php"><img src="img/form.png"></a>
                <a href="cadastro-pet.php"><p>Registre seu pet</p></a>
            </div>
            <div class="caixa1">
                <a href="cadastro.php"><img src="img/registrese.png"></a>
                <a href="cadastro.php"><p>Faça seu cadastro</p></a>
            </div>   
            <div class="caixa1">
